...
def prepare_file_info(source_dirs, target_ct_dirs):
    file_info_list = []
...
file_info_list = prepare_file_info(source_dirs, target_ct_dirs)
...
filtered_training = data['training']
filtered_validation = data['validation']
filtered_test = data['test']

# Data update
data['name'] = "AMOS_CT_and_MR"
